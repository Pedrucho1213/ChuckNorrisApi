...
class JokesRepositoryImpl @Inject constructor(
    ...
    override suspend fun getRandomJoke(category: String?): Result<Joke> = withContext(ioDispatcher){
       runCatching {
    ...
    override suspend fun searchJokes(query: String): Result<List<Joke>> = withContext(ioDispatcher) {
